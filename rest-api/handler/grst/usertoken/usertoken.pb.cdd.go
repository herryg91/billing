...
type fullMethods struct {
	UsertokenAPI_GenerateToken string
	UsertokenAPI_RefreshToken  string
	UsertokenAPI_ValidateToken string
}

var FullMethods = fullMethods{
	UsertokenAPI_GenerateToken: "/usertoken.UsertokenAPI/GenerateToken",
...
var AuthConfigFullMethods = map[string]AuthConfig{
	"/usertoken.UsertokenAPI/GenerateToken": AuthConfig{NeedAuth: false, Roles: []string{"*"}},
	"/usertoken.UsertokenAPI/RefreshToken":  AuthConfig{NeedAuth: false, Roles: []string{"*"}},
	"/usertoken.UsertokenAPI/ValidateToken": AuthConfig{NeedAuth: false, Roles: []string{"*"}},
}
...
func RegisterUsertokenAPIGrstServer(grpcRestServer *grst.Server, hndl UsertokenAPIServer) {
	...
	forward_UsertokenAPI_GenerateToken_0 = grpcRestServer.GetForwardResponseMessage()
